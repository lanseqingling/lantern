...
Lantern AI 是面向个人漫画创作者的 AI 漫画创作工作台。它把漫画、一话、故事分镜、页面编排、单格精修、图片资产、Agent 协作、阅读预览和导出放在一个可持续编辑的空间中。创作者既可以直接使用工作台和内置 Agent，也可以通过 MCP 与配套 Skill，让支持的外置 Agent 在同一套创作能力与作品边界内继续推进作品。
